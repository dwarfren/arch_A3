...
*
* Description: This class provides the abstract interface for the register micro services, RegServices.
* The implementation of these abstract interfaces can be found in the RegServices.java class.
...
*
* Internal Methods:
*  String newUser() - creates a new user in the orderinfo database
*
...
public interface RegServicesAI extends java.rmi.Remote
{
	/*******************************************************
	* Creates a new user from the provided arguments.
	* Returns an OK message or an error string.
	*******************************************************/

	String newUser(String username, String password) throws RemoteException;
